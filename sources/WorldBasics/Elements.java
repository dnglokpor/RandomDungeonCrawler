 ...
 * contains the definition of the base elements of this world. the 4 elements
 * are Air, Earth, Fire and Water. some world objects will be given an
 * element as elemental attributes. Elements have interractions between
 * each other thus elemental attributes will also rule the interraction
 * between objects with elemental attributes.
 * elements will be based on an base Element object. Element
 * will be built using an enum that identify each element by its name
...
public class Elements {
    ...
    /** Element object:
     * this object will be the base that all 4 elements inherit. this
     * sets an elemental id that will be used for calculating weakness and
     * strength between elements. these are the interraction rules:
    ...
    public static abstract class Element{
        ...
        /** constructor:
         * expects a name and an id. for best readability, use constants 
         * defined at the top of the WorldBasics.Elements package.
         * @param id
         */
         ...
         * this.elementalID == other.elementalID or 
        ...
        /**
         * returns a boolean that is true if 
         * this.effectiveness() == other.elementalID.
         * otherwise returns false
         * @param other
         * @return a boolean
         */
